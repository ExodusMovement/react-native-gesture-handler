...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ExodusForks/react-native-gesture-handler"
  s.license      = "MIT"
  s.author       = { package["author"]["name"] => package["author"]["email"] }
  s.source       = { :git => "https://github.com/ExodusForks/react-native-gesture-handler", :tag => "#{s.version}" }
